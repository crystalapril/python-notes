...
language = [
    ...
    ('Arc'        , 2008, {'Paul Graham'}),
    ('Go'         , 2009, {'Rob Pike', 'Ken Thompson'}),
    ('Rust'       , 2010, {'Graydon Hoare'}),
    ('Kotlin'     , 2011, {'JetBrains'}),
    ('Elixir'     , 2011, {'José Valim'}),
    ('Elm'        , 2012, {'Evan Czaplicki'}),
    ('Julia'      , 2012, {'Jeff Bezanson'}),
    ('Purescript' , 2013, {'Phil Freeman'}),
